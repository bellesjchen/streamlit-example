...
with col1:
     color1 = st.color_picker('pick the starting color', 'rgb(3,5,7)',key=1)
     st.write(f"you picked {color1}")
with col2:
     color2 = st.color_picker('pick the ending color', 'rgb(3,5,7)',key=2)
     st.write(f"you picked {color2}")
with col3:
     color3 = st.color_picker('pick the text color', 'rgb(3,5,7)',key=3)
